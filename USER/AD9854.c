...
void AD9854_IO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6| GPIO_Pin_7| GPIO_Pin_10| GPIO_Pin_12| GPIO_Pin_13; 
	GPIO_Init(GPIOB ,&GPIO_InitStructure) ; 

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1| GPIO_Pin_2| GPIO_Pin_3| GPIO_Pin_7| GPIO_Pin_8| GPIO_Pin_15; 
...
{
	AD9854_A0 = (addr >> 0) & 0x01;
	AD9854_A1 = (addr >> 1) & 0x01;
	AD9854_A2 = (addr >> 2) & 0x01;
	AD9854_A3 = (addr >> 3) & 0x01;
	AD9854_A4 = (addr >> 4) & 0x01;
	AD9854_A5 = (addr >> 5) & 0x01;
